...
class GifRequester {
  ...
  String _trendingGifsEndpoint() {
    return 'https://api.giphy.com/v1/gifs/trending?api_key=01BdxRWujnufHK49HzxbDee0BSilRkwI&limit=${_numOfGifs}&rating=G';
  }

  String _searchGifsEndpoint() {
    return 'https://api.giphy.com/v1/gifs/search?api_key=01BdxRWujnufHK49HzxbDee0BSilRkwI&q=${_lastSearch}&limit=${_numOfGifs}&offset=${_offset}&rating=G&lang=en';
  }
